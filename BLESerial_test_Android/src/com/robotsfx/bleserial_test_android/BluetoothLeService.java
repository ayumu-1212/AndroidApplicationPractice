...
public class BluetoothLeService extends Service {
    ...
    //BLESerial サービスUUID
	//public static String UUID_BLESERIAL_SERVICE = "569a1101-b87F-490c-92cb-11ba5ea5167c";	//BLESerial
	public static String UUID_BLESERIAL_SERVICE =   "bd011f22-7d3c-0db6-e441-55873d44ef40";	//BLESerial2
	//　BLESerial　受信UUID （Notify)
	//public static String UUID_BLESERIAL_RX = "569a2000-b87F-490c-92cb-11ba5ea5167c";	//BLESerial
	public static String UUID_BLESERIAL_RX =   "2a750d7d-bd9a-928f-b744-7d5a70cef1f9";	//BLESerial2
	// BLESerial 送信UUID （write without response)
	//public static String UUID_BLESERIAL_TX = "569a2001-b87F-490c-92cb-11ba5ea5167c";	//BLESerial
	public static String UUID_BLESERIAL_TX =   "0503b819-c75b-ba9b-3641-6a7f338dd9bd";	//BLESerial2
	//　キャラクタリスティック設定UUID
